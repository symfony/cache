...
if (version_compare(phpversion('relay'), '0.50.0', '>=')) {
    ...
    {
        public function blmovem($srckey, $dstkey, $srcpos, $dstpos, $timeout, $options = null): \Relay\Cluster|array|false|null
        {
        ...
        public function lmovem($srckey, $dstkey, $srcpos, $dstpos, $options = null): \Relay\Cluster|array|false|null
        {
